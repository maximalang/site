  ...
  return (
    <g data-openclaw-primitive="desk" transform={`translate(${x} ${y})`}>
      ...
      <g transform="translate(0 -8)">
        <rect x="-28" y="-21" width="56" height="36" rx="7" fill="#26332f" stroke="#111b18" strokeWidth="3" />
        <rect
  ...
  return (
    <g data-openclaw-primitive="meeting-table" transform={`translate(${x} ${y})`}>
      ...
      {Array.from({ length: 6 }, (_, index) => {
        ...
        return (
          <g key={angle} transform={`translate(${Math.cos(angle) * 94} ${Math.sin(angle) * 66}) rotate(${(angle * 180) / Math.PI + 90})`}>
            <rect x="-13" y="-10" width="26" height="20" rx="8" fill="#446e65" stroke="#294b44" strokeWidth="2" />
...
export function OfficeSofa({ x, y }: Point) {
  return (
    <g data-openclaw-primitive="sofa" transform={`translate(${x} ${y})`}>
      ...
      <rect x="-59" y="-25" width="118" height="51" rx="20" fill="#51756d" stroke="#2e514a" strokeWidth="3" />
...
export function OfficePlant({ x, y }: Point) {
  return (
    <g data-openclaw-primitive="plant" transform={`translate(${x} ${y})`}>
      ...
      <path d="M0 6C-29 0-31-32-6-18C-8-48 20-46 13-16C36-28 40 5 8 9" fill="#5a9268" stroke="#356246" strokeWidth="3" />
      <path d="M0 6v-31M0-8l-16-11M1-4l15-14" fill="none" stroke="#356246" strokeWidth="3" strokeLinecap="round" />
    </g>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M-17-8q0-7 7-10h20q7 3 7 10l-2 24h-30z" fill={colors.outfit} stroke="#362f2a" strokeWidth="2.5" />
        <path d="M-8-17l8 8 8-8" fill="none" stroke={colors.accent} strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <rect x="-13" y="-35" width="26" height="24" rx="10" fill="#e1b18a" stroke="#46352f" strokeWidth="2.5" />
        {colors.variant === 0 ? (
        ...
        <path d="M-3-19q3 2 6 0" fill="none" stroke="#985c58" strokeLinecap="round" strokeWidth="1.7" />
        {colors.variant === 1 ? (
        ...
        {colors.variant === 2 ? (
          <path d="M15-29q10 2 9 12" fill="none" stroke={colors.accent} strokeWidth="3" strokeLinecap="round" />
        ) : null}
