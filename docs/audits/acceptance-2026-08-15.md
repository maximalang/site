...
1. Prove a Broker-selected live LiteLLM dispatch and bounded fallback/failover.
2. Add remaining approval-gated predefined integration mutations without
