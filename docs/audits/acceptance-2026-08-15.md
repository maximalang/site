...
| 18 | Manage MCP/n8n/servers/SSH from the site | PARTIAL | The owner-only Hub registry now creates and lists MCP, n8n, GitHub and SSH endpoints, stores credentials through the encrypted secret store, and never returns plaintext. Actual per-kind health probes, enable/disable lifecycle and execution adapters remain open. |
